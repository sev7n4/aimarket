...
export function useCreationPanel(
  ...
  return (
    ...
    >
      <CreationPanelBody
      showDockJobStatusBar={showDockJobStatusBar}
      ...
      setInspirationVars={setInspirationVars}
      ...
      isDock={isDock}
      dockCompactLine={dockCompactLine}
      creationLane={creationLane}
      canvasItems={canvasItems}
      mentionUploadedAssets={mentionUploadedAssets}
      ...
      setDockFocused={setDockFocused}
      setDockExpanded={setDockExpanded}
      openUpload={openUpload}
      dockIconBtnClassSm={dockIconBtnClassSm}
      uploading={uploading}
      videoReferenceMode={videoReferenceMode}
      videoReferences={videoReferences}
      setVideoReferences={setVideoReferences}
      smartMultiShots={smartMultiShots}
      setSmartMultiShots={setSmartMultiShots}
      firstLastMotionPrompt={firstLastMotionPrompt}
      setFirstLastMotionPrompt={setFirstLastMotionPrompt}
      uploadVideoReference={uploadVideoReference}
      videoPickCandidates={videoPickCandidates}
      videoPickCandidatesLoading={videoPickCandidatesLoading}
      applyVideoPickCandidate={applyVideoPickCandidate}
      readOnly={readOnly}
      pending={pending}
      videoUploading={videoUploading}
      smartMultiDegraded={smartMultiDegraded}
      agentLaneAvailable={agentLaneAvailable}
      handleCreationLaneChange={handleCreationLaneChange}
      showInlineUploadStack={showInlineUploadStack}
      uploadPreviews={uploadPreviews}
      setUploadPreviewIndex={setUploadPreviewIndex}
      setUploadPreviews={setUploadPreviews}
      setAssetIds={setAssetIds}
      isStudioDock={isStudioDock}
      textareaRef={textareaRef}
      prompt={prompt}
      setPrompt={setPrompt}
      polishCandidates={polishCandidates}
      resetPolish={resetPolish}
      syncMentionStateFromPrompt={syncMentionStateFromPrompt}
      rotatingPlaceholder={rotatingPlaceholder}
      rotatingText={rotatingText}
      effectiveMode={effectiveMode}
      dockShouldExpand={dockShouldExpand}
      ...
      cyclePolishCandidate={cyclePolishCandidate}
      polishCandidateIndex={polishCandidateIndex}
      referenceChips={referenceChips}
      handleRemoveReferenceChip={handleRemoveReferenceChip}
      mentionedMasks={mentionedMasks}
      focusEdit={focusEdit}
      sessionId={sessionId}
      assetIds={assetIds}
      routeHint={routeHint}
      ...
      skillInFlight={skillInFlight}
      orchSkillBusy={orchSkillBusy}
      orchSkillRun={orchSkillRun}
      skillIdle={skillIdle}
      ...
      cancelSkillRunAction={cancelSkillRunAction}
      agentEnabled={agentEnabled}
      homeDirectSubmit={homeDirectSubmit}
      agentRun={agentRun}
      agentBusy={agentBusy}
      cancelAgentRunAction={cancelAgentRunAction}
      showStackUpload={showStackUpload}
      dockIconBtnClass={dockIconBtnClass}
      reversing={reversing}
      handlePromptReverse={handlePromptReverse}
      outputPrefMode={outputPrefMode}
      handleOutputPrefModeChange={handleOutputPrefModeChange}
      models={models}
      modelId={modelId}
      ...
      handleVideoReferenceModeChange={handleVideoReferenceModeChange}
      videoDurationSec={videoDurationSec}
      setVideoDurationSec={setVideoDurationSec}
      videoResolution={videoResolution}
      setVideoResolution={setVideoResolution}
      videoAutoMeta={videoAutoMeta}
