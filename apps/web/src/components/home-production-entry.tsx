...
export function HomeProductionEntry() {
  ...
  function goProduction() {
    trackEntry("home_hero");
    router.push(buildProductionStudioUrl());
  }

  function goEcommerce() {
    trackEntry("home_hero_ecommerce");
    router.push(buildStudioUrl("canvas", { mode: "ecommerce", title: "电商套图" }));
  }

  function goCanvas() {
    trackEntry("home_hero_canvas");
    router.push(buildStudioUrl("canvas", { mode: "image" }));
  }
