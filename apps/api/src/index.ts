...
import { storyCanvasShare } from "./routes/story-canvas-share.js";
import { workflowTemplates } from "./routes/workflow-templates.js";
import { workflowAgent } from "./routes/workflow-agent.js";
...
authed.route("/story-canvas/share", storyCanvasShare);
authed.route("/workflow-templates", workflowTemplates);
authed.route("/workflow-agent", workflowAgent);
