...
export const STUDIO_TOOLS: StudioToolDefinition[] = [
  ...
  },
  {
    id: "tts",
    name: "TTS 配音",
    description: "短剧对白语音合成",
    category: "compose",
    defaultPrompt: "自然中文对白配音",
    pricingFactor: 0.5,
  },
  {
    id: "lipsync",
  ...
  },
  {
    id: "camera",
    name: "摄像机控制",
    description: "调整摄像机俯仰、水平角度与景别，为视频生成添加运镜参数",
    category: "edit",
    defaultPrompt: "按指定运镜参数生成视频",
    pricingFactor: 1.0,
  },
  {
    id: "lighting",
    name: "灯光控制",
    description: "可视化添加与调整场景光源",
    category: "edit",
    defaultPrompt: "调整场景灯光",
    pricingFactor: 1.2,
    requiresSource: true,
  },
  {
    id: "grid-split",
    name: "宫格切分",
    description: "将宫格图切分为独立图片",
    category: "edit",
    defaultPrompt: "宫格切分 3×3",
    pricingFactor: 0.5,
    requiresSource: true,
  },
  {
    id: "video-inpaint",
    name: "视频精准编辑",
    description: "对视频关键帧进行局部重绘，传播到相邻帧",
    category: "edit",
    defaultPrompt: "对视频指定区域进行精准编辑",
    pricingFactor: 2.0,
    requiresSource: true,
  },
  {
    id: "music-gen",
    name: "AI 音乐生成",
    description: "根据风格描述生成背景音乐",
    category: "compose",
    defaultPrompt: "生成一段符合场景氛围的背景音乐",
    pricingFactor: 1.5,
  },
  {
    id: "turnaround-360",
    name: "360 度角度呈现",
    description: "基于参考图生成 8 个方向的展示图，360 度全方位呈现主体",
    category: "compose",
    defaultPrompt: "生成主体 360 度各角度展示图",
    pricingFactor: 3.0,
    requiresSource: true,
  },
  {
    id: "multi-cam-9",
    name: "多机位 9 宫格",
    description: "同一参考图的 9 个固定机位（俯/仰/正/背/特/远/45°等）批量生成",
    category: "compose",
    defaultPrompt: "生成 9 个不同机位的同场景画面",
    pricingFactor: 3.0,
    requiresSource: true,
  },
  {
    id: "multi-cam-25",
    name: "多机位 25 宫格",
    description: "LLM 拆解场景为 25 个连贯镜头，按 5×5 宫格批量出图",
    category: "compose",
    defaultPrompt: "将场景拆解为 25 个连贯镜头并生成对应画面",
    pricingFactor: 6.0,
  ...
  },
  {
    id: "camera-control",
    name: "摄像机控制",
    description: "基于景别/俯仰/水平角配置重新生成图像",
    category: "compose",
    defaultPrompt: "按指定摄影机参数重新生成画面",
    pricingFactor: 1.2,
    requiresSource: true,
  },
  {
    id: "url-scraper",
    name: "URL 爬取",
    description: "从产品官网提取标题、描述与图片等信息",
    category: "compose",
    defaultPrompt: "提取产品信息",
    pricingFactor: 0.2,
  },
];
